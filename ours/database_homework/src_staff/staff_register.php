...
<table width="1110" height="750" border="1" align="center">
  <tr>
    <td height="200" colspan="2"><img src="../images/staffback.png" width="1100" height="200" alt=""/></td>
  </tr>
  <form name="staff_sign" method="post" action="staff_reg_fun.php">
  <tr align="center">
    <td height="550" >
    <p>
      <label for="textfield" style="font-size: 24px">账&nbsp;&nbsp;号:</label>
      <input type="text" name="staff_id" id="textfield" style="height: 24px">
    </p>
    <p>
        <label for="password" style="font-size: 24px">密&nbsp;&nbsp;码:</label>
        <input type="password" name="staff_pwd" id="password" style="height: 24px">
    </p>
    <p>
