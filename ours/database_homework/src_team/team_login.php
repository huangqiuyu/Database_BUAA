  ...
  <tr align="center">
    <td height="270" bgcolor="#94E0B6">
     <p>编&nbsp;&nbsp;号：
      ...
      <p>
      	<input type="button" name="register" value="注册" style="width: 85px; height: 35px;background-color:#32B16C;font-size: 18px;color: #FFFFFF" onclick="window.location.href='stu_register.php'"/>
      </p></td>
  </tr>
  </form>
